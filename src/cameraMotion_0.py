...
def process_image_list(w_dir, image_dir, dump_path, model_path, seg_dir, file_list='image.list'):
    ...
    for image_name in fp_image_list:
        ...
        outfile = dump_path + "res_" + image_name
        ...
        max_pos, faces,  ss, ap, ev, iso, pred = findSuggestion(infile, dump_path, model_path, geo_list[i], env_list[i], seg_dir)
...
if __name__ == '__main__':
    ...
    w_dir = sys.argv[1]
    seg_dir = sys.argv[2] # dumps of clusters
