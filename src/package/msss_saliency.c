...
static char __pyx_k_mnt_windows_Copy_ysrawat_cse_gm[] = "/mnt/windows/Copy ysrawat.cse@gmail.com/Research/Project/code/photography-assistance/src/package/msss_saliency.pyx";
